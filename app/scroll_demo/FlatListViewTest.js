...
export default class FlatListViewTest extends Component {
    ...
    onEndReached = (info: { distanceFromEnd: number }) => {
        //往数组的第一位插入数据，模拟数据新增 , unshift()会返回数组的长度
        this.state.data.push(new this.ItemData('https://pic2.zhimg.com/v2-8f11b41f995ca5340510c1def1c003d1.jpg',
            '下拉刷新添加的数据——————' + this.count, 475843));
        this.count++;
    };
